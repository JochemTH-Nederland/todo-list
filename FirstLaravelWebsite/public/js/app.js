...
var todoListContent = document.getElementById('todo-list');
...
function _addItem() {
  _addItem = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
    var value, _item;
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            _item = _objectSpread(_objectSpread({}, item), {}, {
              message: value
            });
            items.push(_item);
            newItemInput.value = "";
            _context2.next = 9;
            return sendRequest("POST", "add-item", {
              item: _item
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 5;
            return fetch('http://localhost:8000/' + route, fetchData);
